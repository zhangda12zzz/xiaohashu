...
public class StpInterfaceImpl implements StpInterface {
     ...
     * @return
     */
    // 自动帮助处理受检异常，不用，无需在方法签名中声明 throws，也无需 try-catch
    @SneakyThrows
    @Override
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (CollUtil.isNotEmpty(userRoleKeys)) {
            ...
            if (CollUtil.isNotEmpty(rolePermissionsValues)) {
                // Google Guava 库 提供的一种创建 ArrayList 的便捷写法, 新版本没必要了
    ...
    public List<String> getRoleList(Object loginId, String loginType) {
        ...
        // 将 JSON 字符串转换为 List<String> 集合 >> {根据返回值进行推断}
